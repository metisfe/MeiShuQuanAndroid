...
import com.metis.meishuquan.model.topline.Comments;
...
public class CommentListFragment extends BaseFragment {
    ...
    private List<Comments> lstAllComments = new ArrayList<>();
    private CommentsAdapter adapter;

    private Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            List<Comments> result = (List<Comments>) msg.obj;
            switch (msg.what) {
            ...
            public void onCompleted(ReturnInfo<String> result, Exception exception, ServiceFilterResponse response) {
                ...
                if (result != null) {
                    ...
                    if (commentsData != null) {
                        List<Comments> lstHostComments = commentsData.getData().getHostComments();
                        List<Comments> lstNewComments = commentsData.getData().getNewComments();

                        if (lstHostComments != null && lstHostComments.size() > 0) {
                            Comments commentGroup = new Comments();
    ...
    private class CommentsAdapter extends BaseAdapter {
        ...
        public CommentsAdapter(List<Comments> lstAllComments) {
        ...
        public View getView(final int i, View convertView, ViewGroup viewGroup) {
            ...
            if (convertView == null) {
                ...
                if (lstAllComments.get(i).getGroup().equals("热门评论") || lstAllComments.get(i).getGroup().equals(("最新评论"))) {
                    ...
                    view = LayoutInflater.from(MainApplication.UIContext).inflate(R.layout.fragment_topline_comment_list_item, null);
